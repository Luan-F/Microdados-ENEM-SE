...
internal sealed class BuscarExemploQueryHandler : IQueryHandler<BuscarExemploQuery, ExemploResponse>
{
    //private readonly dynamic _sqlConnectionFactory;

    //public BuscarExemploQueryHandler(dynamic sqlConnectionFactory)
    //{
    ...
    public async Task<Result<ExemploResponse>> Handle(BuscarExemploQuery request, CancellationToken cancellationToken)
    {
        ...
        return Result.Success<ExemploResponse>(new ExemploResponse());
    }
}